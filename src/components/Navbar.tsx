...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0A0A0A] border-b border-[#1F1F23] shadow-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-semibold bg-[#121215] hover:bg-[#18181c] border-[#27272a] text-zinc-200 transition-all"
            ...
            >
              ...
              <span className="font-semibold text-zinc-100 truncate max-w-[120px] sm:max-w-none">
            ...
            {isRoleDropdownOpen && (
              <div 
                className="absolute right-0 mt-2 w-72 bg-[#0e0e11] rounded-xl shadow-2xl border border-[#27272a] py-2 z-50 animate-in fade-in zoom-in-95 duration-150"
          ...
          <button
            ...
            className="p-2 rounded-lg border border-[#27272a] text-zinc-400 hover:text-indigo-400 hover:bg-[#141417] transition-colors"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 pl-1.5 pr-1 py-1 rounded-lg hover:bg-[#141417] transition-colors"
            >
              <img
